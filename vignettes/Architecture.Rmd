...
* The class *GOF_model_test_injector* is not part of the diagram.
  It facilitates to create a *GOF_model_test* instance for 
  R-objects that inherit for example from *lm* or *glm*.
